...
export class Client {
    ...
    queryGames(weekNumber: number | undefined, year: string | undefined, sport: number | undefined, returnOnlyGamesThatHaveStarted: boolean | undefined): Promise<void> {
        ...
        if (returnOnlyGamesThatHaveStarted === null)
            throw new Error("The parameter 'returnOnlyGamesThatHaveStarted' cannot be null.");
    ...
    updateLeagueUserSettings(leagueId: string | undefined, showAllGames: boolean | undefined, showIconsForPicks: boolean | undefined): Promise<void> {
        ...
        if (showAllGames === null)
            throw new Error("The parameter 'showAllGames' cannot be null.");
        else if (showAllGames !== undefined)
            url_ += "showAllGames=" + encodeURIComponent("" + showAllGames) + "&";
        if (showIconsForPicks === null)
            throw new Error("The parameter 'showIconsForPicks' cannot be null.");
    ...
    getWeekPickForUser(leagueId: string | undefined, weekNumber: number | undefined, leagueType: number | undefined): Promise<void> {
        ...
        if (weekNumber === null)
            ...
            url_ += "weekNumber=" + encodeURIComponent("" + weekNumber) + "&";
        if (leagueType === null)
            throw new Error("The parameter 'leagueType' cannot be null.");
...
export class LeagueDTO implements ILeagueDTO {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.settings = _data["settings"] ? LeagueSettings.fromJS(_data["settings"]) : <any>undefined;
...
export class SpreadGamePickDTO implements ISpreadGamePickDTO {
    ...
    toJSON(data?: any) {
        ...
        data["spreadWhenPicked"] = this.spreadWhenPicked ? this.spreadWhenPicked.toJSON() : <any>undefined;
        data["timeOfPick"] = this.timeOfPick ? this.timeOfPick.toISOString() : <any>undefined;
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.gamePicks)) {
            ...
            for (let item of this.gamePicks)
                data["gamePicks"].push(item ? item.toJSON() : <any>undefined);
        }
